...
DOMANDE_DISCIPULUS = [
    ...
    {"id": 4, "domanda": "Romanorum oppida ______________ a Germanis oppugnabantur", "opzioni": ["magnā cum ferociā", "magnam ferociam", "ex magnis ferocis", "magnae ferociae"], "corretta": "magnā cum ferociā", "spiegazione": "Il complemento di modo si esprime con cum + ablativo; se il sostantivo è accompagnato da un aggettivo, il cum può essere interposto (o omesso)."},
